...
@router.callback_query(F.data == "roles_back:main", IsSuperAdmin())
...
@router.callback_query(F.data.startswith("roles_cat:"), IsSuperAdmin())
...
@router.callback_query(F.data.startswith("roles_subcat:"), IsSuperAdmin())
...
@router.callback_query(F.data == "roles_back:yandex", IsSuperAdmin())
...
@router.callback_query(F.data.startswith("roles_switch:"), IsSuperAdmin())
...
@router.callback_query(F.data == "roles_show_current", IsSuperAdmin())
...
@router.callback_query(F.data == "roles_delete_msg", IsSuperAdmin())
