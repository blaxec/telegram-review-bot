...
def upgrade() -> None:
    ...
    # --- ИЗМЕНЕНИЕ: Мы больше не создаем тип вручную. ---
    # SQLAlchemy создаст его автоматически при вызове op.add_column.
...
def downgrade() -> None:
    ...
    # При откате тип нужно удалять явно, это оставляем.
