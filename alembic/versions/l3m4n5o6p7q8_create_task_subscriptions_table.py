...
def upgrade() -> None:
    ...
    # --- ИСПРАВЛЕНИЕ: Указываем SQLAlchemy, что не нужно создавать этот тип, ---
    # --- так как он был создан в предыдущей миграции f1e2d3c4b5a6. ---
...
def downgrade() -> None:
    ...
    # При откате миграции тип удалять не нужно, за это отвечает миграция, которая его создала.
    # ### end Alembic commands ###