...
# --- РАСШИРЕНИЕ СИСТЕМЫ АДМИНОВ ---
# Вы можете добавлять сюда больше администраторов.
# 1. Добавьте в .env файл: ADMIN_ID_3=123456789
# 2. Добавьте его в список ADMIN_IDS ниже.
ADMIN_ID_1 = int(os.getenv("ADMIN_ID_1", 0))
ADMIN_ID_2 = int(os.getenv("ADMIN_ID_2", 0))
# ADMIN_ID_3 = int(os.getenv("ADMIN_ID_3", 0)) # <- Пример добавления
ADMIN_IDS = [ADMIN_ID_1, ADMIN_ID_2] # <- Добавьте сюда ADMIN_ID_3
# ------------------------------------
